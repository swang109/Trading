...
#resultDF = polygonJsonProcessor.historicQuotesToDFConsolidatedIntoSecond("TSLA", "2019-09-26")
resultDF = polygonJsonProcessor.historicQuotesToDF("TSLA", "2019-09-26", "13:30:00", "13:30:10")
